    ...
    return (
        <AnimatedPage>
            ...
            <div className="kpi-grid">
                ...
                <KPICard title="Avg Lead Time" value="3.2" suffix="d" change="1.8d" changeType="positive" icon={Clock} gradient="linear-gradient(135deg, #14b8a6, #10b981)" />
                <KPICard title="Best Model" value="96" suffix="%" change="Ensemble" changeType="positive" icon={Award} gradient="linear-gradient(135deg, #8b5cf6, #ec4899)" />
            </div>
                    ...
                    <tbody>
                        {anomalies.map((a, i) => (
                            <tr key={i}>
                                ...
                                <td style={{ fontWeight: 600, color: a.type === 'spike' ? '#ef4444' : '#f59e0b' }}>{a.magnitude}</td>
                                <td>{a.confidence}</td>
                                <td>
