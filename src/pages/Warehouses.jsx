...
const warehouses = [
    ...
    { name: 'Tokyo Hub', code: 'TKY', stock: 9800, capacity: 11000, daysOfSupply: 11, skus: 4100, status: 'attention', color: '#10b981' },
    { name: 'Singapore DC', code: 'SGP', stock: 4300, capacity: 8000, daysOfSupply: 22, skus: 1900, status: 'healthy', color: '#f59e0b' },
    { name: 'Mumbai Warehouse', code: 'BOM', stock: 7100, capacity: 9000, daysOfSupply: 9, skus: 2600, status: 'critical', color: '#3b82f6' },
    { name: 'Sydney DC', code: 'SYD', stock: 3800, capacity: 6000, daysOfSupply: 16, skus: 1500, status: 'healthy', color: '#ec4899' },
]
    ...
    return (
        <AnimatedPage>
            ...
            <div className="kpi-grid">
                ...
                <KPICard title="Total Stock Units" value="39700" change="3.2% up" changeType="positive" icon={MapPin} gradient="linear-gradient(135deg, #10b981, #14b8a6)" />
                <KPICard title="In-Transit Shipments" value="14" change="5 arriving soon" changeType="positive" icon={Truck} gradient="linear-gradient(135deg, #8b5cf6, #ec4899)" />
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 12 }}>
                            ...
                            <div>
                                ...
                                <p style={{
                                    ...
                                    fontFamily: 'Outfit',
                                    fontSize: '1.1rem',
                                    color: wh.daysOfSupply <= 10 ? '#ef4444' : wh.daysOfSupply <= 14 ? '#f59e0b' : '#10b981',
                                }}>
                                    {wh.daysOfSupply}d
                                </p>
                            </div>
                    ...
                    <tbody>
                        {redistributions.map((r, i) => (
                            <tr key={i}>
                                ...
                                <td style={{ color: '#10b981', fontWeight: 600 }}>{r.savings}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
