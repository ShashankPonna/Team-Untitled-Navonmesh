...
function Scene() {
    const warehouses = useMemo(() => [
        ...
        { lat: 35.7, lon: 139.7, color: '#10b981' },   // Tokyo
        { lat: 1.35, lon: 103.8, color: '#f59e0b' },   // Singapore
        { lat: -33.9, lon: 151.2, color: '#ec4899' },   // Sydney
        { lat: 19.1, lon: 72.9, color: '#3b82f6' },    // Mumbai
        { lat: 37.6, lon: -122.4, color: '#14b8a6' },   // San Francisco
        { lat: 55.8, lon: 37.6, color: '#ef4444' },    // Moscow
    ], [])
