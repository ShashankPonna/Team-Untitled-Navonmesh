...
function Scene() {
    const boxes = useMemo(() => [
        ...
        { pos: [0, 2, -3], color: '#ef4444', scale: 0.4, speed: 1.1 },
        { pos: [-2.5, 1.5, -2], color: '#f59e0b', scale: 0.55, speed: 0.7 },
        { pos: [1.5, 0.5, 2], color: '#10b981', scale: 0.65, speed: 1.3 },
        { pos: [-0.5, -1.5, -1], color: '#6366f1', scale: 0.45, speed: 0.6 },
        { pos: [4, 0, 0], color: '#06b6d4', scale: 0.35, speed: 1.4 },
        { pos: [-4, -0.5, 1], color: '#8b5cf6', scale: 0.5, speed: 0.8 },
    ], [])
    ...
    return (
        <>
            ...
            <spotLight position={[0, 8, 0]} angle={0.5} penumbra={1} intensity={0.4} color="#3b82f6" />
