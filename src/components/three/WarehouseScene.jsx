    ...
    const shelves = useMemo(() => [
        ...
        },
        {
            ...
            boxes: [
                ...
                { pos: [0.5, 0.35, 0], size: [0.4, 0.6, 0.4], color: '#6366f1' },
        ...
        },
        {
            ...
            boxes: [
                ...
                { pos: [0.6, 0.35, 0], size: [0.35, 0.4, 0.5], color: '#10b981' },
                { pos: [0, 1.55, 0], size: [0.5, 0.5, 0.5], color: '#f59e0b' },
                { pos: [0.7, 1.55, 0], size: [0.4, 0.35, 0.4], color: '#06b6d4' },
            ]
        },
    ], [])
